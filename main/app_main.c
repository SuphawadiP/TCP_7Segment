...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(client, "KMITL/SIET/65030269/qos1", "data_3", 0, 1, 0);
        ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);

        msg_id = esp_mqtt_client_subscribe(client, "KMITL/SIET/65030269/qos0", 0);
        ESP_LOGI(TAG, "sent subscribe successful, msg_id=%d", msg_id);

        // 12. add subscribe topic
        msg_id = esp_mqtt_client_subscribe(client, "KMITL/SIET/65030269/topic/7seg", 0);
        ESP_LOGI(TAG, "sent subscribe successful, msg_id=%d", msg_id);


        msg_id = esp_mqtt_client_subscribe(client, "KMITL/SIET/65030269/qos1", 1);
        ESP_LOGI(TAG, "sent subscribe successful, msg_id=%d", msg_id);

        msg_id = esp_mqtt_client_unsubscribe(client, "KMITL/SIET/65030269/qos1");
    ...
    case MQTT_EVENT_SUBSCRIBED:
        ...
        msg_id = esp_mqtt_client_publish(client, "KMITL/SIET/65030269/qos0", "data", 0, 0, 0);
        ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);
        break;
